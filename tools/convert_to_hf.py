...
def main():
    ...
    if 'qwen3' in cfg.path.lower():
        from projects.hf.models_qwen3vl.configuration_sa2va_chat import Sa2VAChatConfigQwen
        from projects.hf.models_qwen3vl.modeling_sa2va_qwen import Sa2VAChatModelQwen
    else:
        from projects.hf.models_qwen2_5_vl.configuration_sa2va_chat import Sa2VAChatConfigQwen
        from projects.hf.models_qwen2_5_vl.modeling_sa2va_qwen import Sa2VAChatModelQwen
    ...
    if 'qwen' in arch_type:
        if 'qwen3' in cfg.path.lower():
            os.system(f"cp -pr ./projects/hf/models_qwen3vl/* {args.save_path}")
        else:
            os.system(f"cp -pr ./projects/hf/models_qwen2_5_vl/* {args.save_path}")
    else:
